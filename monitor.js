...
var refreshDelay = 240000; //default is 5 mins (300000), feel free to change
var currentStock = [];
var newStock = [];
    ...
    for (i in newItems) {
      ...
      hook.send({
        embeds: [{
          ...
          "footer": {
	        "icon_url": "https://hypemonitor.de/assets/hypemonitor.png",
	        "text": "Powered by HypeMonitor.de"
	       	},
